  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-12 md:px-10 md:py-16">
      ...
      <div className="mt-8 grid gap-6 md:grid-cols-2">
        ...
        {/* Status control */}
        <div className="rounded-md border border-border bg-card p-6">
          <div className="mb-3 font-mono text-[10px] uppercase tracking-[0.25em] text-muted">Status</div>
          <form action={updateOrderStatusAction} className="flex items-center gap-3">
            ...
            <button
              type="submit"
              className="h-10 rounded-full bg-foreground px-5 font-mono text-[10px] uppercase tracking-[0.25em] text-background transition-opacity hover:opacity-90"
            >
              Speichern
            </button>
          </form>
          <p className="mt-3 font-mono text-[10px] text-muted">
            „Versandt“ löst die Versand-Mail aus · „Storniert“ bucht Bestand zurück.
          </p>
        </div>
      </div>
