...
export default function SectionHeading({ eyebrow, title, subtitle }: SectionHeadingProps) {
  return (
    <Reveal className="mx-auto mb-8 max-w-3xl text-center md:mb-16">
      ...
      <h2 className="font-display text-2xl font-bold tracking-tight text-balance text-ink sm:text-3xl md:text-[2.75rem] md:leading-[1.15]">
        {title}
      </h2>
      {subtitle && (
